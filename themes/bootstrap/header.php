...
<html lang="en">
	<head>
		...
		<meta http-equiv="refresh" content="<?php echo $metaRefresh['seconds']; ?>; URL=<?php echo $metaRefresh[
    'location'
]; ?>" />
		<?php endif; ?>
		<title><?php
  ...
  ?></title>
		...
		<link rel="stylesheet" href="<?php echo $this->themePath(
      'css/flux.css',
  ); ?>" type="text/css" media="screen" title="" charset="utf-8" />
		<link href="<?php echo $this->themePath(
      'css/flux/unitip.css',
...
?>
			...
			<?php endif; ?>
								...
								<!-- Credit balance -->
								<?php
//if (in_array($params->get('module'), array('donate', 'purchase'))) include 'main/balance.php'
?>
