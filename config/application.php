...
return [
    ...
    'SiteTitle' => 'Enyxsis Control Panel', // This value is only used if the theme decides to use it.
    'ThemeName' => ['bootstrap'], // Names of the themes you would like list for use in the footer. Themes are in FLUX_ROOT/themes.
    ...
    'ReCaptchaPublicKey' => '6LfdjsUZAAAAAFg8hXUflfPveiXjaNM-hqGkijq3', // This is your reCAPTCHA public key [REQUIRED FOR RECAPTCHA] (sign up at http://www.google.com/recaptcha)
    'ReCaptchaPrivateKey' => '6LfQjsUZAAAAADU5osNZm_cKtKdZWQhBeGL_bT94', // This is your reCAPTCHA private key [REQUIRED FOR RECAPTCHA] (sign up at http://www.google.com/recaptcha)
    ...
    ], // These are the receiver e-mail addresses who are allowed to receive payment.
    ...
    // PCRE Format Pattern. It's recommended you add your gameserver, webserver and server owner's IPs here.
    'IpWhitelistPattern' => '(127\.0\.0\.1|0(\.[0\*]){3})', // WARNING: This string isn't escaped so be careful which chars you use!
    ...
    'BanPaymentStatuses' => [
        // Payment statuses that will automatically ban the account owner if received.
    ...
    'ShopImageExtensions' => [
        // These are the image extensions allowed for uploading in the item shop.
        'png',
        'jpg',
        'gif',
        'bmp',
    ...
    'TidyIgnore' => [['module' => 'captcha'], ['module' => 'guild', 'action' => 'emblem']],
