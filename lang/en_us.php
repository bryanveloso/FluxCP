...
return [
    ...
    'NotAcceptingDonations' =>
        "We're sorry, but we are currently not accepting any donations.  We apologize for the inconvenience.",
    ...
    'EmailChangeInfo' =>
        'If you would like to change the e-mail address registered under your account, you can fill out the below form.',
    'EmailChangeInfo2' =>
        'After submitting the form, you will be required to confirm your new e-mail address (an e-mail will be sent to the new address with a link).',
    ...
    'PasswordChangeInfo' =>
        'Please enter your current password, then enter the new password you would like to use and re-enter it to confirm.',
    ...
    'EmailConfirmFailed' =>
        'There has been a technical difficulty while updating your e-mail address, please contact an admin.',
    ...
    'AccountCreateEmailSent' =>
        'An e-mail has been sent containing account activation details, please check your e-mail and activate your account to log-in.',
    'AccountCreateFailed' =>
    ...
    'AccountCreateInfo' =>
        'Please read our %s (ToS) before registering for an account, to ensure that you understand the rules of holding an account with our private Ragnarok Online game server.',
    ...
    'UsernameTooShort' => sprintf(
        'Your username should be around %d to %d characters long.',
        Flux::config('MinUsernameLength'),
        Flux::config('MaxUsernameLength'),
    ),
    'UsernameTooLong' => sprintf(
        'Your username should be around %d to %d characters long.',
        Flux::config('MinUsernameLength'),
        Flux::config('MaxUsernameLength'),
    ),
    ...
    'EmailAddressInUse' =>
        "The e-mail address you've entered is already registered to another account.  Please use a different e-mail address.",
    ...
    'ResendEmailSent' =>
        'Your confirmation code has been resent, please check your e-mail and proceed to activate your account.',
    'ResendHeading' => 'Resend Confirmation E-mail',
    'ResendInfo' =>
        'Please enter your account name and e-mail address you used during the registration of the account to have us resend your confirmation e-mail.',
    ...
    'ResetPwDone2' =>
        'Your password has been reset, but we failed to deliver the e-mail containing your new password.  Please reset again to resolve this issue.',
    // - account/transfer
    ...
    'TransferInfo2' =>
        'Enter the amount you would like to transfer and the character name belonging to the account you would like your credits transferred to.',
    ...
    'TermsInfo2' =>
        "FOR CONTROL PANEL ADMINISTRATOR:  You may add your server's ToS in this view file directly.  The location of the view file is: %s",
    ...
    'CMSPageText' =>
        'This module enables server admins and staff to create pages within their website with no prior flux/coding knowledge. The built-in news system can also be swapped out for an rss feed by modifying the application settings.',
    ...
    'CMSNewsRSSNotFound' =>
        'RSS feed can\'t be found. Make sure the CMSNewsRSS setting is correct, or switch CMSNewsType to 1 to use built-in news system!',
    ...
    'SDPointerChatLog' =>
        'We recommend pasting to <a href="http://pastebin.com" target="_blank">pastebin.com</a> then putting the link in here.',
